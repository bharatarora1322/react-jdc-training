(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ? factory(exports, require('./acorn'))
    : typeof define === 'function' && define.amd
      ? define(['exports', './acorn'], factory)
      : factory(
          (
            (global.acorn = global.acorn || {}),
            (global.acorn.loose = global.acorn.loose || {})
          ),
          global.acorn
        );
    ...
    switch (starttype) {
      ...
      case __acorn.tokTypes._continue:
        ...
        if (this.semicolon() || this.canInsertSemicolon()) {
          ...
          node.label =
            this.tok.type === __acorn.tokTypes.name ? this.parseIdent() : null;
          this.semicolon();
        }
      ...
      case __acorn.tokTypes._for:
        ...
        if (
          ...
          if (
            ...
            (this.tok.type === __acorn.tokTypes._in || this.isContextual('of'))
          ) {
  ...
  lp$2.parseExprAtom = function() {
    ...
    switch (this.tok.type) {
      ...
      case __acorn.tokTypes._super:
        var type =
          this.tok.type === __acorn.tokTypes._this ? 'ThisExpression' : 'Super';
        node = this.startNode();
        this.next();
        return this.finishNode(node, type);
