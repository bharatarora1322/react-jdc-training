(function(global, factory) {
  ...
  pp$1.parseLabeledStatement = function(node, maybeName, expr) {
    ...
    var kind = this.type.isLoop
      ? 'loop'
      : this.type === types._switch ? 'switch' : null;
  ...
  pp$1.parseVar = function(node, isFor, kind) {
    ...
    for (;;) {
      ...
      if (this$1.eat(types.eq)) {
        ...
        !(isFor && (this$1.type === types._in || this$1.isContextual('of')))
      ) {
        this$1.raise(
          this$1.lastTokEnd,
  ...
  pp$1.parseClassId = function(node, isStatement) {
    node.id =
      this.type === types.name
        ? this.parseIdent()
        : isStatement === true ? this.unexpected() : null;
  };
    ...
    switch (expr.type) {
      case 'Identifier':
        ...
        if (bindingType && bindingType !== 'none') {
          if (
            ...
            this.raiseRecoverable(
              expr.start,
              "Identifier '" + expr.name + "' has already been declared"
            );
          }
          if (bindingType === 'var') {
      ...
      case 'MemberExpression':
        if (bindingType) {
          this.raiseRecoverable(
            expr.start,
            (bindingType ? 'Binding' : 'Assigning to') + ' member expression'
          );
        }
        break;
 ...
 */
  pp$5.canDeclareVarName = function(name) {
    ...
    return (
      !has(currentScope.lexical, name) && !has(currentScope.parentLexical, name)
    );
  };
