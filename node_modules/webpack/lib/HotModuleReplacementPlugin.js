  ...
  apply(compiler) {
    ...
    compiler.plugin('compilation', (compilation, params) => {
      ...
      compilation.mainTemplate.plugin('require-extensions', function(source) {
        ...
        buf.push(
          this.requireFn + '.h = function() { return hotCurrentHash; };'
        );
        return this.asString(buf);
      });

      compilation.mainTemplate.plugin('bootstrap', function(
        source,
        chunk,
        hash
      ) {
      ...
      params.normalModuleFactory.plugin('parser', (parser, parserOptions) => {
        parser.plugin(
          'expression __webpack_hash__',
          ParserHelpers.toConstantDependency('__webpack_require__.h()')
        );
        parser.plugin(
          'evaluate typeof __webpack_hash__',
        ...
        parser.plugin('evaluate Identifier module.hot', function(expr) {
          return ParserHelpers.evaluateToIdentifier(
            'module.hot',
            !!this.state.compilation.hotUpdateChunkTemplate
          )(expr);
        });
