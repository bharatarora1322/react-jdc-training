...
class SourceMapDevToolPlugin {
  constructor(options) {
    ...
    this.moduleFilenameTemplate =
      options.moduleFilenameTemplate || 'webpack:///[resourcePath]';
          ...
          if (sourceMapFilename) {
            ...
            if (sourceMapFile.indexOf('[contenthash]') !== -1) {
              sourceMapFile = sourceMapFile.replace(
                /\[contenthash\]/g,
                crypto.createHash('md5').update(sourceMapString).digest('hex')
              );
            }
            const sourceMapUrl = path
            ...
            if (currentSourceMappingURLComment !== false) {
              asset.__SourceMapDevToolData[file] = compilation.assets[
                ...
                currentSourceMappingURLComment.replace(/\[url\]/g, sourceMapUrl)
              );
            }
