...
class Module extends DependenciesBlock {
  ...
  isUsed(exportName) {
    ...
    if (this.isProvided(exportName)) return Template.numberToIdentifer(idx);
    return exportName;
  }

  isProvided(exportName) {
    if (!Array.isArray(this.providedExports)) return null;
...
Object.defineProperty(Module.prototype, 'chunks', {
  ...
  set() {
    throw new Error(
      'Readonly. Use Module.addChunk/removeChunk to modify chunks.'
    );
  }
});
