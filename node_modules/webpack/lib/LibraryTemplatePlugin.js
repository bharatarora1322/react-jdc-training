  ...
  apply(compiler) {
    compiler.plugin('this-compilation', compilation => {
      if (this.exportProperty) {
        ...
        compilation.apply(
          new ExportPropertyMainTemplatePlugin(this.exportProperty)
        );
      }
      switch (this.target) {
        case 'var':
        ...
        case 'assign':
          compilation.apply(
            new SetVarMainTemplatePlugin(accessorAccess(undefined, this.name))
          );
          break;
        case 'this':
        case 'window':
        ...
        case 'commonjs':
          ...
          else compilation.apply(new SetVarMainTemplatePlugin('exports', true));
          break;
        case 'commonjs2':
