...
ModuleFilenameHelpers.createFooter = function createFooter(
  module,
  requestShortener
) {
  if (!module) module = '';
...
ModuleFilenameHelpers.replaceDuplicates = function replaceDuplicates(
  array,
  fn,
  comparator
) {
...
ModuleFilenameHelpers.matchPart = function matchPart(str, test) {
  ...
  if (Array.isArray(test)) {
    return (
      test.map(asRegExp).filter(function(regExp) {
