  ...
  apply(moduleTemplate) {
    moduleTemplate.plugin('render', function(moduleSource, module) {
      ...
      const defaultArguments = [
        ...
        module.exportsArgument || 'exports'
      ];
      if (
        (module.arguments && module.arguments.length !== 0) ||
        module.hasDependencies(d => d.requireWebpackRequire !== false)
      ) {
        defaultArguments.push('__webpack_require__');
      }
      source.add(
        '/***/ (function(' +
          defaultArguments.concat(module.arguments || []).join(', ') +
          ') {\n\n'
      );
