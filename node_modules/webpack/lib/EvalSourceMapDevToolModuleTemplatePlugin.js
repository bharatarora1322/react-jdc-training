...
class EvalSourceMapDevToolModuleTemplatePlugin {
  constructor(compilation, options) {
    ...
    this.moduleFilenameTemplate =
      options.moduleFilenameTemplate || 'webpack:///[resource-path]?[hash]';
  ...
  apply(moduleTemplate) {
    ...
    moduleTemplate.plugin('module', function(source, module) {
      ...
      if (sourceMap.sourcesContent) {
        sourceMap.sourcesContent = sourceMap.sourcesContent.map(function(
          content,
          i
        ) {
          return `${content}\n\n\n${ModuleFilenameHelpers.createFooter(
            modules[i],
            this.requestShortener
          )}`;
        }, this);
      ...
      const footer =
        self.sourceMapComment.replace(
          /\[url\]/g,
          `data:application/json;charset=utf-8;base64,${new Buffer(
            JSON.stringify(sourceMap),
            'utf8'
          ).toString('base64')}`
        ) + `\n//# sourceURL=webpack-internal:///${module.id //eslint-disable-line
