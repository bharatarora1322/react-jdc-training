...
class ImportPlugin {
  ...
  apply(compiler) {
    ...
    compiler.plugin('compilation', (compilation, params) => {
      ...
      compilation.dependencyTemplates.set(
        ImportEagerContextDependency,
        new ImportEagerContextDependency.Template()
      );
      ...
      compilation.dependencyTemplates.set(
        ImportWeakContextDependency,
        new ImportWeakContextDependency.Template()
      );
      ...
      compilation.dependencyTemplates.set(
        ImportLazyOnceContextDependency,
        new ImportLazyOnceContextDependency.Template()
      );
      ...
      compilation.dependencyTemplates.set(
        ImportLazyContextDependency,
        new ImportLazyContextDependency.Template()
      );
