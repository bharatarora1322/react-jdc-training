...
class HarmonyModulesHelpers {
  static getModuleVar(state, request) {
    ...
    return `__WEBPACK_IMPORTED_MODULE_${idx}_${request
  ...
  static getActiveExports(module, currentDependency) {
    ...
    var currentIndex = currentDependency
      ? module.dependencies.indexOf(currentDependency)
      : -1;
      ...
      .reduce((arr, data) => {
        ...
        if (
          ...
          names.forEach(function(name) {
            if (name && arr.indexOf(name) < 0) arr.push(name);
          });
        }
        return arr;
      }, []);
