  ...
  apply(parser) {
    ...
    parser.plugin('call define', expr => {
      ...
      switch (expr.arguments.length) {
        case 1:
          if (
            ...
            isBoundFunctionExpression(expr.arguments[0])
          ) {
            // define(f() {...})
            fn = expr.arguments[0];
        ...
        case 2:
          if (expr.arguments[0].type === 'Literal') {
            ...
            if (
              ...
              isBoundFunctionExpression(expr.arguments[1])
            ) {
              // define("...", f() {...})
              fn = expr.arguments[1];
        ...
        case 3:
          ...
          if (
            ...
            isBoundFunctionExpression(expr.arguments[2])
          ) {
            // define("...", [...], f() {})
            fn = expr.arguments[2];
      ...
      if (array) {
        ...
        const result = parser.applyPluginsBailResult(
      ...
      if (fn && fn.type === 'FunctionExpression') {
        ...
        parser.inScope(fnParams, () => {
          ...
          if (fn.body.type === 'BlockStatement') parser.walkStatement(fn.body);
        ...
        parser.inScope(
          fn.callee.object.params.filter(
            i => ['require', 'module', 'exports'].indexOf(i.name) < 0
          ),
          () => {
            parser.scope.renames = fnRenames;
            parser.scope.inTry = inTry;
    ...
    parser.plugin(
      'call define:amd:array',
      (expr, param, identifiers, namedModule) => {
        if (param.isArray()) {
          param.items.forEach((param, idx) => {
            if (
              param.isString() &&
              ['require', 'module', 'exports'].indexOf(param.string) >= 0
            )
    ...
    parser.plugin('call define:amd:item', (expr, param, namedModule) => {
      if (param.isConditional()) {
        ...
        if (param.string === 'require') {
          ...
          ['require', 'exports', 'module'].indexOf(param.string) >= 0
        ) {
