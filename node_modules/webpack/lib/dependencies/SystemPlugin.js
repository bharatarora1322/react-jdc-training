    ...
    compiler.plugin('compilation', (compilation, params) => {
      params.normalModuleFactory.plugin('parser', (parser, parserOptions) => {
        ...
        function setNotSupported(name) {
          parser.plugin(
            'evaluate typeof ' + name,
            ParserHelpers.evaluateToString('undefined')
          );
          parser.plugin(
            'expression ' + name,
        ...
        parser.plugin(
          ...
          ParserHelpers.toConstantDependency(JSON.stringify('function'))
        );
        parser.plugin(
        ...
        parser.plugin(
          'typeof System',
          ParserHelpers.toConstantDependency(JSON.stringify('object'))
        );
        parser.plugin(
          'evaluate typeof System',
          ParserHelpers.evaluateToString('object')
        );
