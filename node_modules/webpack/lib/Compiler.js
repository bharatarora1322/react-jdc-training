  ...
  _go() {
    ...
    this.compiler.applyPluginsAsync('watch-run', this, err => {
      ...
      const onCompiled = (err, compilation) => {
        ...
        if (
          this.compiler.applyPluginsBailResult('should-emit', compilation) ===
          false
        ) {
...
class Compiler extends Tapable {
  ...
  createChildCompiler(
    ...
    if (this.cache) {
      ...
      if (!this.cache.children[compilerName])
        this.cache.children[compilerName] = [];
      if (this.cache.children[compilerName][compilerIndex])
        childCompiler.cache = this.cache.children[compilerName][compilerIndex];
      else this.cache.children[compilerName].push((childCompiler.cache = {}));
    }
