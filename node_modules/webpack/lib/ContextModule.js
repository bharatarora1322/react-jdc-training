...
class ContextModule extends Module {
  ...
  identifier() {
    ...
    if (this.async) identifier += ` ${this.async}`;
  ...
  readableIdentifier(requestShortener) {
    ...
    if (this.regExp) identifier += ` ${this.prettyRegExp(this.regExp + '')}`;
  ...
  libIdent(options) {
    ...
    if (this.async) identifier += ` ${this.async}`;
    if (this.recursive) identifier += ' recursive';
    if (this.addon)
  ...
  getLazySource(blocks, id) {
    ...
    const map = blocks
      ...
      .reduce((map, item) => {
        ...
        map[item.userRequest] = [item.dependency.module.id].concat(
