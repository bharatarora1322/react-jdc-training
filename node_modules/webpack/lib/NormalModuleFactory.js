...
class NormalModuleFactory extends Tapable {
      ...
      resolver(result, (err, data) => {
        ...
        this.applyPluginsAsyncWaterfall(
          ...
          (err, result) => {
            ...
            let createdModule = this.applyPluginsBailResult(
              'create-module',
              result
            );
            if (!createdModule) {
            ...
            createdModule = this.applyPluginsWaterfall0(
              'module',
              createdModule
            );
          ...
          try {
            loaders.forEach(item => {
              if (
                ...
                item.options = this.ruleSet.findOptionsByIdent(
  ...
  getParser(parserOptions) {
    let ident = 'null';
    if (parserOptions) {
      if (parserOptions.ident) ident = parserOptions.ident;
      else ident = JSON.stringify(parserOptions);
    }
