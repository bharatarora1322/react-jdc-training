...
class CachePlugin {
      ...
      compiler.plugin('compilation', compilation => {
        if (!compilation.notCacheable) {
          ...
          compilation.warnings.push(
            new Error(
              `CachePlugin - Cache cannot be used because of: ${compilation.notCacheable}`
            )
          );
        }
      });
  ...
  applyMtime(mtime) {
    if (this.FS_ACCURENCY > 1 && mtime % 2 !== 0) this.FS_ACCURENCY = 1;
    else if (this.FS_ACCURENCY > 10 && mtime % 20 !== 0) this.FS_ACCURENCY = 10;
