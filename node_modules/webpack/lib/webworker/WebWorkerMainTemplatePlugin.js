  ...
  apply(mainTemplate) {
    ...
    mainTemplate.plugin('bootstrap', function(source, chunk, hash) {
      if (chunk.chunks.length > 0) {
        const chunkCallbackName =
          this.outputOptions.chunkCallbackName ||
          Template.toIdentifier(
            'webpackChunk' + (this.outputOptions.library || '')
          );
        return this.asString([
          source,
          `this[${JSON.stringify(
    ...
    mainTemplate.plugin('hot-bootstrap', function(source, chunk, hash) {
      ...
      const hotUpdateFunction =
        this.outputOptions.hotUpdateFunction ||
        Template.toIdentifier(
          'webpackHotUpdate' + (this.outputOptions.library || '')
        );
      ...
      return (
        source +
        '\n' +
        `var parentHotUpdateCallback = this[${JSON.stringify(
          hotUpdateFunction
        )}];\n` +
