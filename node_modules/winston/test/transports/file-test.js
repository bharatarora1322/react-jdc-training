...
vows
  .describe('winston/transports/file')
  .addBatch({
    ...
    'Error object in metadata #610': {
      topic: function() {
        ...
        fileTransport.log(
          ...
          'test message',
          myErr,
          this.callback.bind(this, null, myErr)
        );
      },
      'should not be modified': function(err, myErr) {
        ...
        assert.deepEqual(
          Object.getOwnPropertyNames(myErr),
          Object.getOwnPropertyNames(new Error('foo'))
        );
      }
    }
  })
    ...
    'Date object in metadata': {
      topic: function() {
        ...
        fileTransport.log(
          ...
          'test message',
          obj,
          this.callback.bind(this, null, obj)
        );
      },
