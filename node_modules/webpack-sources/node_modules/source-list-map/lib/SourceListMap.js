...
class SourceListMap {
  ...
  add(generatedCode, source, originalSource) {
    if (typeof generatedCode === 'string') {
      if (source) {
        this.children.push(
          new SourceNode(generatedCode, source, originalSource)
        );
      } else if (
        this.children.length > 0 &&
        this.children[this.children.length - 1] instanceof CodeNode
      ) {
  ...
  toStringWithSourceMap(options) {
    ...
    return {
      ...
      map: {
        ...
        sourcesContent: mappingsContext.hasSourceContent
          ? arrays.sourcesContent
          : undefined,
        mappings: mappings
      }
    };
