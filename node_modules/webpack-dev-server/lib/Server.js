...
function Server(compiler, options) {
  ...
  app.get('/__webpack_dev_server__/live.bundle.js', (req, res) => {
    ...
    fs
      .createReadStream(path.join(__dirname, '..', 'client', 'live.bundle.js'))
      .pipe(res);
  });
  ...
  app.get('/webpack-dev-server.js', (req, res) => {
    res.setHeader('Content-Type', 'application/javascript');
    fs
      .createReadStream(path.join(__dirname, '..', 'client', 'index.bundle.js'))
      .pipe(res);
  });
  ...
  app.get('/webpack-dev-server/*', (req, res) => {
    ...
    fs
      .createReadStream(path.join(__dirname, '..', 'client', 'live.html'))
      .pipe(res);
  });
...
Server.prototype.listen = function(port, hostname) {
  ...
  const returnValue = this.listeningApp.listen.apply(
    this.listeningApp,
    arguments
  );
